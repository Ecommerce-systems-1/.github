...
| 04 | [AI Guardrails Service](https://github.com/Ecommerce-systems-1/ai-guardrails-service) | Platform Trust | Python · FastAPI · Next.js · Tailwind | [🟢 Live Demo](https://huggingface.co/spaces/RishabhHajela/ai-guardrails-service) |
| 05 | [High-Volume Flash Sale Simulator](https://github.com/Ecommerce-systems-1/high-volume-flash-sale-simulator) | Platform Infrastructure | Go · Redis · PostgreSQL · k6 | [🔵 GitHub Repo](https://github.com/Ecommerce-systems-1/high-volume-flash-sale-simulator) |
| 06 | [Personalized Recommendations Engine](https://github.com/Ecommerce-systems-1/personalized-recommendations-engine) | Search & Discovery | Python · scikit-learn · FastAPI · Next.js | [🔵 GitHub Repo](https://github.com/Ecommerce-systems-1/personalized-recommendations-engine) |
| 07–23 | Full pipeline in progress | Various | Varied | 🔜 Coming soon |